...
class listener:
    ...
    def __init__(self):
        ...
        self.timer_task = rospy.Timer(rospy.Duration(0.001), self.timerCallback_tasks)
        self.tasks_sub = rospy.Subscriber("/task_states", TasksSchedule, self.callback_tasks)
